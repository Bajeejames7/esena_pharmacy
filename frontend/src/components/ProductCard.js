        ...
        <div className={contentClasses[layout]}>
          ...
          <div className="mb-3" role="status">
            {isOutOfStock ? (
              ...
              <span className="inline-block bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 text-xs font-medium px-2 py-1 rounded-full">Only {product.stock} left</span>
            ) : isMediumStock ? (
              <span className="inline-block bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-xs font-medium px-2 py-1 rounded-full">{product.stock} in stock</span>
            ) : (
              <span className="inline-block bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-medium px-2 py-1 rounded-full">In Stock ({product.stock})</span>
            )}
          </div>
