            ...
            <GlassCard className="p-8">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-800 dark:text-white group-hover:text-glass-blue dark:group-hover:text-blue-400 transition-colors">Phone</h3>
                    <p className="text-gray-600 dark:text-gray-300">0768103599</p>
                  </div>
                </a>
